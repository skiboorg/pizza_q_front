...
<!--            </div>-->
            <q-radio :disabled="!currentCity.online_payment_active" v-if="orderData.delivery_type==='Курьером'" class="q-mb-sm" dense  v-model="orderData.payment" val="online" label="Онлайн" />
